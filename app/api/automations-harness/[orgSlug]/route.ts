...
} from "@/app/app/[orgSlug]/automations/actions";

// Test harness: invokes the real automations server actions with the caller's
// real session, the same approach as the other module harnesses. Every gate
// lives inside the actions themselves.

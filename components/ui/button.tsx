...
function Button({
  ...
  return (
    <ButtonPrimitive
      data-slot="button"
      // A plain Button renders a native <button>; when a caller passes `render`
      // (e.g. a Link), the element is not a <button>, so tell Base UI to apply
      // non-native semantics instead of warning. An explicit nativeButton wins.
